...
<head>
  ...
  <script src="https://kit.fontawesome.com/a4e3a27962.js" crossorigin="anonymous"></script>
</head>
<body>
...
<div class = "footer-container">
	<div class = "footer">
		...
		<div class = "footer-heading footer-2">
				...
				<p> Download Now </p>
				<svg xmlns:x="http://ns.adobe.com/Extensibility/1.0/" xmlns:i="http://ns.adobe.com/AdobeIllustrator/10.0/" xmlns:graph="http://ns.adobe.com/Graphs/1.0/" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Livello_1" x="0px" y="0px" viewBox="0 0 5435.8 1604" style="enable-background:new 0 0 5435.8 1604;" xml:space="preserve">
<style type="text/css">
...
<path class="st10" d="M501.7,305.7l781.9,444.2c25.4,14.3,39.7,33,41.9,52.1c0-20.9-13.8-41.9-41.9-57.9L501.7,299.9  c-56.1-32.1-101.6-5.3-101.6,58.8v5.8C400.1,300.3,445.6,274,501.7,305.7z"/>
		...
		<div class = "footer-heading footer-3">
				...
				<h2>Directions on Map<h2>
				
				<div class="mapouter">
				    <div class="gmap_canvas">
					   <iframe width="400" height="250" id="gmap_canvas" src="https://maps.google.com/maps?q=2880%20Broadway,%20New%20York&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0">
					   </iframe>
						       <a href="https://fmovies-online.net">
						       </a><br>
							       <style>.mapouter{position:relative;text-align:left;height:200px;width:25px;}
							       </style>
